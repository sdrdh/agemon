...
> All 33 items completed. See [docs/tasks/archive.md](docs/tasks/archive.md).

## Phase 2: Frontend Foundation ✅
> 28/30 items completed. See [docs/tasks/archive.md](docs/tasks/archive.md).
...
For any phase, read its file or `grep -r "keyword" docs/tasks/` to find relevant tasks.

| Phase | Status | Pending | File |
|-------|--------|---------|------|
